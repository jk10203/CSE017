 ...
 *
 * This program was made in order to modify the ArrayList class so that another inner class for ListIterator
    ...
    private class ArrayListIterator implements ListIterator<E>{
        ...
        */
	    ...
	    public E next() {
			...
			E value = elements[current];
			current += 1; 
            return value;
		}
        /**
            @return true if current did not reach the beginning of the list, false otherwise
         */
        public boolean hasPrevious() {
            return current > 0; //if equal then false
		}
        /**
            @return the value of the current element and moves the index current to the previous element
         */
	    public E previous() { //why did mine not work
            /*if(elements[current] == null){
			  throw new NoSuchElementException();
            }*/
			E value = elements[current];
