 ...
 *
 * This program was made in order to create the parent class Person that specifies a person's name, address,
 * phone, email. It also includes an override method in order to format said information.
 */
...
public class Person{
    ...
    public String toString(){
        ...
        //%s (format for name) is a placeholder the first item in the list is a string
        return out;
    }
}